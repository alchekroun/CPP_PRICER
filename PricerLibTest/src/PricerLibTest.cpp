...
public:
	...
	TEST_METHOD(mc_get_option_price_basic) {
		...
		// THEN
		Assert::AreEqual(43.05, custom_round(option_price.first, 2));
	}
	...
	TEST_METHOD(mc_get_option_price_optimized) {
		...
		// THEN
		Assert::AreEqual(43.09, custom_round(option_price.first, 2));
	...
	TEST_METHOD(binomial_get_option_price) {
		...
		// THEN
		Assert::AreEqual(1.0, custom_round(result, 2));
	}
	...
	TEST_METHOD(bsm_get_theta) {
		...
		// THEN
		Assert::AreEqual(-1.88, custom_round(result, 2));
	}
	...
	TEST_METHOD(bsm_get_vega) {
		...
		// THEN
		Assert::AreEqual(12.54, custom_round(result, 2));
	}
	...
	TEST_METHOD(bsm_get_rho) {
		...
		// THEN
		Assert::AreEqual(109.74, custom_round(result, 2));
	}
	};
}
