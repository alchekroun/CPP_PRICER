...
std::pair<double, double> pricer::mcarlo::get_option_price(bool const is_call, double const s0, double const strike, double const rate, double const volatility, double const maturity, int const nb_path) {
